...
> **Status:** KP:1 is currently an editor's draft (`v0.8.2-preview` / `KP:1 Public Draft — 2026-06`). The contribution model described here is provisional and will change when the Foundation is formed and a contributor agreement is in place. See [GOVERNANCE.md](GOVERNANCE.md) for the full governance picture.
