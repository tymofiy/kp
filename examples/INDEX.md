...
*Regenerated 2026-06-10 for v0.8.4-preview (matrix cells re-verified against pack contents). The index is regenerated when example packs change; verify by running `python3 conformance/run.py` (23/23 expected) before relying on the table data.*
