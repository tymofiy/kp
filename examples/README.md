...
Curated sample Knowledge Packs that demonstrate the format. Every example pack is validated by `python3 conformance/run.py` as part of the conformance suite (15/15 passing as of v0.8.0-preview).
...
Expected output: `15/15 passed` (11 fixtures in `../conformance/fixtures/` + 4 examples here).
