...
A future revision of the spec may promote some of the rubrics here to enforced semantic constraints (`SC-12` and beyond). For v0.8.3-preview, AUTHORING.md is the producer-side contract; the conformance suite does not check against it.
