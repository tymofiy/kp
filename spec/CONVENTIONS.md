...
| 3 | **Locale tag** | `en-US` | PACK.yaml: `linguistic_epoch: en-US-2026` | BCP 47 language tag; year suffix anchors semantic drift. Note: `linguistic_epoch` is a decoration field per CORE.md §3 (no consumer behavior in v0.8.2-preview; new producers SHOULD prefer `extensions.*`) |
