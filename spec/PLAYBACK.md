...
This entire companion is **experimental** for v0.8.2-preview. Producers MAY emit `PlaybackPlan` artifacts and consumers SHOULD treat them as advisory.

### Stable for v0.8.2-preview

The following are committed for the v0.8.2-preview tag and will not change without a deprecation cycle:
...
Producers MAY emit `PlaybackPlan` artifacts in v0.8.2-preview packs as advisory metadata; consumers SHOULD treat them as informational and tolerant of schema drift.
